...
const Tariff = () => (
  <>
    ...
    <Helmet>
      <title>
        Room Tariff | Hotel Rahgir & Guest House Chikhli Near Valsad
      </title>
      <meta
        name="description"
        content="Check room tariff and pricing at Hotel Rahgir & Guest House in Chikhli near Valsad. Affordable AC, Non-AC and Deluxe rooms with clean stay and quality service."
      />
    </Helmet>
    {/* ======================================= */}
    ...
    <div className="bg-gradient-to-b from-yellow-50 via-white to-yellow-50 py-16 px-4 sm:px-8 lg:px-16">
        ...
        <table className="min-w-full border-collapse bg-white rounded-2xl shadow-md overflow-hidden text-left">
          ...
          <tbody className="text-gray-800 text-sm font-medium divide-y divide-gray-200">
            <tr className="hover:bg-yellow-50 transition duration-200">
              <td className="py-4 px-6">Non-AC Room</td>
            ...
            <tr className="hover:bg-yellow-50 transition duration-200">
              <td className="py-4 px-6">Deluxe Room</td>
      ...
      <div className="mt-8 bg-white border border-yellow-100 rounded-xl shadow-sm p-6 text-gray-700 space-y-2 text-sm sm:text-base max-w-xl mx-auto leading-relaxed">
        ...
        <p>
          <strong>Note:</strong> All taxes are applicable as per government
          norms.
        </p>
      ...
      <div className="mt-10 flex justify-center">
        <img
          ...
          alt="Hotel Rahgir & Guest House Chikhli deluxe room with clean and comfortable stay"
